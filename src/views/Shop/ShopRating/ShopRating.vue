        ...
        <div class="ratings-content">
            <div class="overview">
                <div class="overview-left">
                    ...
                    <div class="rank">高于同类型机构99%</div>
                </div>
                <div class="overview-right">
                    <div class="score-wrapper">
                        <span class="title">课程质量</span>
                    ...
                    <div class="delivery-wrapper">
                        <span class="title">评价课程时间</span>
                        <span class="delivery">62分钟</span>
                    </div>
                </div>
            </div>
            <div class="split"></div>
  ...
  <ul class="rating-ul">
    <li class="rating-item" v-for="(rating, index) in filterRatings" :key="index">
      ...
      <div class="content">
        ...
        <div class="recommend">
          <span class="iconfont" :class="rating.rateType===0 ? 'iconfont icon-dianzan' : 'iconfont icon-cai'"></span>
...
export default {
    data(){
        return {
            onlyShowText:true,//是否只显示评价文本
            selectType:2//指定的评价类型
        }
    },
    components: {
        Star
        ...
        filterRatings(){
            ...
            return ratings.filter(rating=>{
                ...
                /*条件1：满意度筛选
                    selectType:0/1/2
                    rateType:0/1
                    selecType===rateType||selectType===2
                条件2：有值筛选
